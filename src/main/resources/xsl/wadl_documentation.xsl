<?xml version="1.0" encoding="UTF-8"?>
	<!--
		...
		HTML documentation from WADL, by Mark Nottingham <mnot@yahoo-inc.com>.

		Copyright (c) 2006-2008 Yahoo! Inc. This work is licensed under the
		Creative Commons Attribution-ShareAlike 2.5 License. To view a copy of
...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	extension-element-prefixes="exsl" xmlns="http://www.w3.org/1999/xhtml"
	...
	<!--
		debug $resources <xsl:template match="/"> <xsl:copy-of
		select="$resources"/> </xsl:template>
	-->
	...
	<xsl:template name="get-element">
		...
		<p>
			<em>
				Source:
				<a href="http://www.mnot.net/webdesc/%7B$source%7D">
	...
	<xsl:template name="link-qname">
		...
		<xsl:choose>
			...
			<xsl:otherwise>
				...
				<a
					href="http://www.mnot.net/webdesc/%7B$definition/ancestor-or-self::wadl:include%5B1%5D/@href%7D"
